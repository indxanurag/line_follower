...
int   CORNER_SENSITIVITY  = 400;
float CORNER_BOOST        = 2.5f;
int   CORNER_DURATION_MS  = 250;
...
void loadAll(){
  ...
  if(prefs.isKey("n0")){
    ...
    CORNER_SENSITIVITY =prefs.getInt("cs",400);
    CORNER_BOOST       =prefs.getFloat("cb",2.5f);
    CORNER_DURATION_MS =prefs.getInt("cd",250);
